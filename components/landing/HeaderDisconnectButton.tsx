...
export function HeaderDisconnectButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-lg border border-zinc-300 bg-white text-sm font-semibold text-zinc-700 transition-colors hover:bg-zinc-50 ${
